...
def generate_lor(name, start_date, end_date):
    ...
    c.drawString(0.75 * inch, content_y_start - 20, f"I am delighted & excited to welcome you to PredictRAM for Financial Analyst Internship")
    ...
    c.drawString(0.75 * inch, content_y_start - 120, "")
    ...
    c.drawString(0.75 * inch, content_y_start - 200, f"We look forward to you joining us. Please do not hesitate to call us for any information. ")
    ...
    c.drawString(0.75 * inch, content_y_start - 260, "")
